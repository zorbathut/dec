...
class MonsterDec : Dec.Dec
{
  ...
  // Dec references are not limited to a tree structures. Decs can reference other decs in circles, reference other decs of the same type, and even reference themselves.
